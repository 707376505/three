...
<body>
                    ...
                    <div class="row">
                        <div class="col-lg-9 d-lg-block d-md-none d-sm-none d-none ">
                            <nav class="navbar navbar-expand-lg justify-content-left">
                                <ul id="chargemanMenu" class="navbar-nav">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Chargeman</li>
                    </ol>
                </div>
            </div>
            <!-- end row-->
	...
	<script type="text/javascript">
		function myfun() {
			$("#chargemanMenu").html('<li class="dropdown"><button id="" onclick="" type="button" class="btn btn-primary">菜单内容</button></li>');
		}
